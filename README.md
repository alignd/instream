...
Configuration is given as a tuple of `{ module, function, arguments }`. The
log entry (one of `Instream.Log.QueryEntry` or `Instream.Log.WriteEntry`) will
be inserted as the first argument of the method call.
